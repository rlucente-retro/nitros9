********************************************************************
* scfg - Wildbits configuration editor
*
* by John Federico
*
...
* sys/currfont loads the currently select font on scfg startup.
*
*   3      2025/12/26  Matt Massie
* Added NitrOS-9 logo to scfg.
* scfg -d pulls default settings.
* scfg -dl pulls default settings and logo.
*
...
lvl1msg             fcc !Level-1 only supports scfg -d and scfg -dl!
                    fcb       C$CR
