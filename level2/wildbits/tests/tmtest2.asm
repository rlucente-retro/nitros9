...
map0                fcc       "/dd/TESTS/l1_platform_80x15.bin"
                    fcb       13
tiles1              fcc       "/dd/TESTS/mountains_bm"
                    fcb       13
clut1               fcc       "/dd/TESTS/mountains_clut"
                    fcb       13
map1                fcc       "/dd/TESTS/l2_mountains_40x15.bin"
                    fcb       13
tiles2              fcc       "/dd/TESTS/clouds_bm"
                    fcb       13
clut2               fcc       "/dd/TESTS/clouds_clut"
                    fcb       13
map2                fcc       "/dd/TESTS/l3_clouds_40x15.bin"
                    fcb       13
                    emod
eom                 equ       *
                    end
